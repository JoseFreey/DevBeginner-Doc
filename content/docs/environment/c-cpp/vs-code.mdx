...
![vscode_icon | original repo: https://github.com/Aikoyori/ProgrammingVTuberLogos](images/vs-code/icon.png)
...
进入下一步并点击 ***“Browse Language Extensions”***

然后在左侧弹出的市场中安装 ***“C/C++ Extension Pack”*** 这个扩展
