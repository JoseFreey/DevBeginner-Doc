...
![小熊猫C++-2](./images/red-panda/rc-2.png)
:::
...
![下载8.png](./images/red-panda/下载8.png)

选择 `简体中文` 并点击 `OK`

![下载9.png](./images/red-panda/下载9.png)

用户协议选择 `我接受`，安装的用户选择 `只为我自己安装`

![下载10.png](./images/red-panda/下载10.png)

![下载11.png](./images/red-panda/下载11.png)

接下来的安装路径自己选择即可，没有的话默认也可以。

![下载12.png](./images/red-panda/下载12.png)

点击完成即安装结束

![安装完成.png](./images/red-panda/安装完成.png)
