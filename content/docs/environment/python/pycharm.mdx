...
## 下载
PyCharm 分为**社区版**、**专业版**。**目前官方的最新版本为 2025**。作为初学者或者普通用户，使用免费的社区版就可以满足我们大部分的开发需求了。
...
<Callout title="Tips">在校学生可以申请免费使用专业版的（JETBRAINS旗下的全家桶产品都可以使用，列如IDEA）这里以社区版为例</Callout>
...
24.1 版之后的可以直接在 `setting` 中找到 `System setting`，找到 `Language and Region`，就可以切换成中文了
