...
| | | *……* |
| Java 17.0 | 2021.09 | 发布Java 17.0，版本号也称为21.9，是长期支持版本。 |
| | | *……* |
| Java 19.0 | 2022.09 | 发布Java 19.0，版本号也称为22.9。 |

## Java 技术体系

### Java SE

- 全称 Java Standard Edition，也称 Java 标准版。
...
- 全称 Java Enterprise Edition，也称 Java 企业版。
...
- 全称 Java Micro Edition，也称 Java 小型版。
...
<img src="\images\Grammer-DataStructure\java\jdk1.png" style={{width: "50%", height: "auto"}}></img>
...
- jdk17 中文版：https://doc.qzxdp.cn/jdk/17/zh/api/index.html
- jdk21 官方版：https://docs.oracle.com/en/java/javase/21/docs/api/help-doc.html
