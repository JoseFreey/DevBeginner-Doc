...
一个线程同时只能执行一个任务，但可以同时向一个线程池提交多个任务。![image-20240625164308135](./images/image-20240625164308135.png)
...
![image-20240625174625992](./images/image-20240625174625992.png)
